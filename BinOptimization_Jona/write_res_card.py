...
def parseOptions():
    ...
    parser.add_option('--signal'	 , dest='signal'    , type='string', default=''	     , help='signal')
    parser.add_option('-p', '--parent'   , dest='parent'    , type='string', default=''      , help='parent directory')    
...
#        "4"  : "DNNoutSM_kl_1_HHKin_mass_raw", # "mdnn__v2__kl1_c2v1_c31__hh_vbf",
    ...
    out_dir = "{2}/cards{1}/{0}/".format(theOutputDir,dname,opt.parent)
...
#		return -1
        ...
        syst = systReader(opt.parent+"../config/systematics_"+opt.year+".cfg",signals,backgrounds,None)
        syst.writeOutput(False)
        syst.verbose(True)
        syst.addSystFile(opt.parent+"../config/systematics_DY"+opt.year+".cfg")
        if opt.theory:
            syst.addSystFile(opt.parent+"../config/syst_th.cfg")
        if(opt.channel == "TauTau"):
            syst.addSystFile(opt.parent+"../config/systematics_tautau.cfg")
        elif(opt.channel == "MuTau"):
            syst.addSystFile(opt.parent+"../config/systematics_mutau.cfg")
        elif(opt.channel == "ETau"):
            syst.addSystFile(opt.parent+"../config/systematics_etau.cfg")
...
if opt.overSel == "" :
	...
	#allSel = ["s1b1jresolvedMcutmHH250_350","s1b1jresolvedMcutmHH350_500","s1b1jresolvedMcutmHH500_700","s1b1jresolvedMcutmHH700_1000","s1b1jresolvedMcutmHH1000_3500","s2b0jresolvedMcutmHH250_350","s2b0jresolvedMcutmHH350_500","s2b0jresolvedMcutmHH500_700","s2b0jresolvedMcutmHH700_1000","s2b0jresolvedMcutmHH1000_3500","sboostedLLMcutmHH250_350","sboostedLLMcutmHH350_500","sboostedLLMcutmHH500_700","sboostedLLMcutmHH700_1000","sboostedLLMcutmHH1000_3500","VBFloosemHH250_350","VBFloosemHH350_500","VBFloosemHH500_700","VBFloosemHH700_1000","VBFloosemHH1000_3500"]
        allSel = ["s1b1jresolvedMcutmHH250_335","s1b1jresolvedMcutmHH335_475","s1b1jresolvedMcutmHH475_725","s1b1jresolvedMcutmHH725_1100","s1b1jresolvedMcutmHH1100_3500","s2b0jresolvedMcutmHH250_335","s2b0jresolvedMcutmHH335_475","s2b0jresolvedMcutmHH475_725","s2b0jresolvedMcutmHH725_1100","s2b0jresolvedMcutmHH1100_3500","sboostedLLMcutmHH250_335","sboostedLLMcutmHH335_475","sboostedLLMcutmHH475_725","sboostedLLMcutmHH725_1100","sboostedLLMcutmHH1100_3500","VBFloosemHH250_335","VBFloosemHH335_475","VBFloosemHH475_725","VBFloosemHH725_1100","VBFloosemHH1100_3500"]
    else:
        ...
        allSel = ["s1b1jresolvedMcutmHH250_335","s1b1jresolvedMcutmHH335_475","s1b1jresolvedMcutmHH475_725","s1b1jresolvedMcutmHH725_1100","s1b1jresolvedMcutmHH1100_3500","s1b1jresolvedMcutInvDR","s2b0jresolvedMcutmHH250_335","s2b0jresolvedMcutmHH335_475","s2b0jresolvedMcutmHH475_725","s2b0jresolvedMcutmHH725_1100","s2b0jresolvedMcutmHH1100_3500","s2b0jresolvedMcutInvDR","sboostedLLMcutmHH250_335","sboostedLLMcutmHH335_475","sboostedLLMcutmHH475_725","sboostedLLMcutmHH725_1100","sboostedLLMcutmHH1100_3500","sboostedLLMcutInvDR","VBFloosemHH250_335","VBFloosemHH335_475","VBFloosemHH475_725","VBFloosemHH725_1100","VBFloosemHH1100_3500","VBFlooseInvDR"]
