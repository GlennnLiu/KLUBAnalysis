...
pt = rt.TPaveText(0.1663218-0.08,0.886316,0.3045977-0.02,0.978947,"brNDC")
pt.SetBorderSize(0)
pt.SetTextAlign(12)
pt.SetTextFont(62)
pt.SetTextSize(0.07)
...
for ch in channels:
	...
	if ch == 'TauTau':
		...
		n=23
	c1 = rt.TCanvas("c1", "c1", 1200,500)#650, 500)
	...
	#pad2.Draw()
        ...
        pt4 = rt.TPaveText(0.4819196+0.036-0.05+0.25,0.7780357+0.02,0.9008929+0.036-0.05,0.8675595+0.015,"brNDC")
        pt4.SetTextAlign(12)
	...
	#pad2.SetLogy(1)
	#c1.Update()
	c1.SaveAs("Output/Comparison_nbins_{0}.png".format(ch))
