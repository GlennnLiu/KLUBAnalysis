...
for ch in channels:
	fin=rt.TFile("/data_CMS/cms/liugeliang/HHbbtautau_histos/Legacy2018_{0}_11Oct2021/analyzedOutPlotter.root".format(ch),"read")
	#fbin=rt.TFile("/data_CMS/cms/liugeliang/HHbbtautau_histos/Legacy2018_24May2021/{0}/analyzedOutPlotter.root".format(ch),"read")
	os.system("mkdir /data_CMS/cms/liugeliang/HHbbtautau_histos/Legacy2018_11Oct2021")
	os.system("mkdir /data_CMS/cms/liugeliang/HHbbtautau_histos/Legacy2018_11Oct2021/{0}".format(ch))
	fout=rt.TFile("/data_CMS/cms/liugeliang/HHbbtautau_histos/Legacy2018_11Oct2021/{0}/analyzedOutPlotter.root".format(ch),"recreate")
	...
	for ca in categories:
		if ch == 'TauTau':
			ExCa=['MD','InvMD']
                        ...
                        ExCa=['DRMD','DRInvMD','InvDRMD','InvDRInvMD']
        
		for mhh in ExCa:
			N=65
			print ch,ca,mhh
			#temp=GetHist(fbin,'DY',ca+mhh,'SR')
			newbins=np.linspace(250,3500,N+1)
			for re in regions:
